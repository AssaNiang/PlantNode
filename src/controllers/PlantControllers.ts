...
private plantService = new PlantService();
    ...
    async getPlantById(req:Request ,res: Response){
        console.log("je suis dans getPlantById");
        try{
            const id = req.params.id;
            const onePlant= await this.plantService.getPlantById(+id);
    ...
    async create(req: Request, res: Response) {
      ...
      async update(req: Request, res: Response) {
        console.log("update PlantController");
      ...
      async delete(req: Request, res: Response) {
        console.log(" delete PlantController");
